...
// ProviderCatalogStep —— "从模型库添加" 的 Locus / PlotCraft 同款 pick stage
//
// 视觉 + 交互镜像 PlotCraft `ProviderCatalogStep.vue` (AGENTS.md 硬规则 #1: 结构对齐, 代码自写):
// - 顶部: 搜索框 (按 provider 名 / endpoint 过滤)
...
<template>
  <div class="catalog-pick-step">
    ...
    <div class="pick-list">
      ...
      >
        <span class="pick-row-main">
          ...
          <span class="pick-row-endpoint">{{ provider.endpoint }}</span>
        </span>
    ...
    <!-- 底部 hint -->
    <p class="pick-hint">
      v0.2 内置 models.dev snapshot · {{ totalInfo }}
    </p>
  </div>
</template>
